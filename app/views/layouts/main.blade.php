        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              @if( Auth::check() )<li><a href="/admin/createlabel" style="color:red;"><span class="glyphicon glyphicon-plus"></span> add labels</a></li>@endif
              @if( Auth::check() )<li><a href="/item/createplanandprice" style="color:red;"><span class="glyphicon glyphicon-plus"></span> add plan and price</a></li>@endif
            </ul>
